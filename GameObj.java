...
public class GameObj
{
    ...
    float widthIs, float heightIs, float strengthIs, Colour c )
    {
        topX   = x;       topY = y;
        width  = widthIs; height = heightIs; strength = strengthIs; 
        colour = c;
    }
    ...
    public float setStrength() { strength = 1; return strength; }
    ...
    public Colour setColour() { colour = Colour.MAGENTA;return colour;}
